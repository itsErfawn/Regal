...
function LoginStepTwo({setStep}:{setStep:(step:number)=>void}) {
  ...
  return (
    <form action={formAction} className="login-col-part w-full">
  ...
  <InputOTPGroup className="gap-2 flex-row-reverse w-full mb-4" >
    ...
    <InputOTPSlot className={` !rounded-sm w-2/12 h-14 !border-neutral-4 ${action.error&&"!border-error"} `} index={1} />
    <InputOTPSlot className={` !rounded-sm w-2/12 h-14 !border-neutral-4 ${action.error&&"!border-error"} `} index={2} />
    <InputOTPSlot className={` !rounded-sm w-2/12 h-14 !border-neutral-4 ${action.error&&"!border-error"} `} index={3} />
    <InputOTPSlot className={` !rounded-sm w-2/12 h-14 !border-neutral-4 ${action.error&&"!border-error"} `} index={4} />
    <InputOTPSlot className={` !rounded-sm w-2/12 h-14 !border-neutral-4 ${action.error&&"!border-error"} `} index={5} />
  </InputOTPGroup>
</InputOTP>
